...
public class AuthService {
    ...
    public com.auction.dto.UserDTO login(String email, String password) throws Exception {
    ...
    public com.auction.dto.UserDTO register(String username, String email, String password) throws Exception {
    ...
    private com.auction.dto.UserDTO mapUserToDTO(User user) {
        return new com.auction.dto.UserDTO(user.getId(), user.getUsername(), user.getEmail());
    }
}