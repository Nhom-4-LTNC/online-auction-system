...
* Realtime bid chart, realtime chat và auto-bidding là hướng phát triển sau.

---

## 9. Báo cáo và video demo

* Báo cáo PDF: [Link báo cáo PDF](docs/FINAL_REPORT.pdf)
* Video demo: [Link video demo](PASTE_VIDEO_DEMO_LINK_HERE)
